...
class PPOTrainer(Trainer):
    ...
    def save_ppo_model(self):
        print("--- save ppo model,learn num {} ---".format(self.learn_num))
        self.strategy.save_model(self.actor, "PPOModel/actor_learn_{}_checkpoint.pt".format(self.learn_num), only_rank0=True)
        self.strategy.save_model(self.critic, "PPOModel/critic_learn_{}_checkpoint.pt".format(self.learn_num), only_rank0=True)
